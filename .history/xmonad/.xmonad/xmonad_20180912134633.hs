...
myTabConfig = def { 
                    ...
                    , inactiveBorderColor = myColorWhite
...
myLayoutHook =  combineTwoP two bar (gapS $ grid) clss |||
                combineTwoP two bar (gapS $ vertical) clss |||
                combineTwoP two bar (gapS $ tabs) clss |||
                combineTwoP two bar (gapL $ tabs) clss |||
                full
    where
