...
myLayoutHook =  combineTwoP two bar grid clss |||
                combineTwoP two bar vertical clss |||
                combineTwoP two bar (gap $ tab) clss |||
                combineTwoP two bar (gapLarge $ tab)clss |||
                full
    where
        centered = gap $ Full
        grid = pad $ gap $ Grid (4/4)
        ...
        barGap =  gaps [(U,20), (D,10), (L,0), (R,0)]
        gap =  gaps [(U,20), (D,20), (L,10), (R,10)]
