...
myLayoutHook =  spacing 20 $ combineTwoP two Tall grid clss |||
                combineTwoP two Tall vertical clss |||
                combineTwoP two Tall tab clss |||
                combineTwoP two Tall centered clss |||
                combineTwoP two Tall display clss |||
                full
    where
        centered = gap Full
        grid = gap Grid (4/4)
